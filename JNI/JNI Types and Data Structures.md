...
- [JNI中的数据类型以及数据结构](#jni中的数据类型以及数据结构)
    ...
    - [Java基本类型](#java基本类型)
    - [Java引用类型](#java引用类型)
    - [Java字段和方法(Field/Method)](#java字段和方法fieldmethod)
    - [JNI Value类型([联合体类型](https://www.cnblogs.com/fengty90/p/3768840.html))](#jni-value类型联合体类型httpswwwcnblogscomfengty90p3768840html)
    - [JNI中的类型签名](#jni中的类型签名)
    - [JNI中UTF-8字符串说明](#jni中utf-8字符串说明)
    - [字符编码说明](#字符编码说明)
    - [JNI为什么定义这些信息](#jni为什么定义这些信息)
        - [基于方法调用](#基于方法调用)
        - [相互保存对方变量以及持有对方引用](#相互保存对方变量以及持有对方引用)
...
## JNI Value类型([联合体类型](https://www.cnblogs.com/fengty90/p/3768840.html))
